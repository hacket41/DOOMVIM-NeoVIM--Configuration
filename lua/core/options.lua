...
-- TypeScript / JavaScript / Web (2 spaces — matches Prettier default)
...
vim.api.nvim_create_autocmd('FileType', {
  pattern = { 'python', 'rust', 'java', 'c', 'cpp', 'c_sharp', 'lua', 'dart' },
  callback = function()
    vim.bo.shiftwidth = 4
    vim.bo.tabstop = 4
...
-- Go and Makefiles require real tabs (not spaces)
vim.api.nvim_create_autocmd('FileType', {
