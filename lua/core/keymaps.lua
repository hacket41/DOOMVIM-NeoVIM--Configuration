...
vim.keymap.set('n', '<leader>ro', '<cmd>Rest open<CR>', { desc = 'Open result pane' })
vim.keymap.set('n', '<leader>rv', '<cmd>Rest env show<CR>', { desc = 'Show environment file' })
vim.keymap.set('n', '<leader>rs', '<cmd>Rest env select<CR>', { desc = 'Select environment file' })
vim.keymap.set('n', '<leader>rg', '<cmd>Rest logs<CR>', { desc = 'Edit logs file' })
vim.keymap.set('n', '<leader>rc', '<cmd>Rest cookies<CR>', { desc = 'Edit cookies file' })

-- Diagnostics List using Trouble
vim.keymap.set('n', '<leader>lx', '<cmd>Trouble diagnostics toggle<cr>')
